(function() {
  ...
  generateBtn.addEventListener('click', () => {
    ...
    if (articleBody) {
      ...
      chrome.runtime.sendMessage({ action: 'generateSummary', text: articleText }, response => {
        if (chrome.runtime.lastError) {
          resultArea.innerText = 'Error: ' + chrome.runtime.lastError.message;
  ...
  askQuestionBtn.disabled = true;
    ...
    if (articleBody) {
      ...
      chrome.runtime.sendMessage({
        ...
        if (chrome.runtime.lastError) {
          questionResultArea.innerText = 'Error: ' + chrome.runtime.lastError.message;
        } else if (response.error) {
